...
async function main() {
  ...
  const instance = await LPExpsoure.deploy(
    ...
    "0x7cA30e86f73528138ace8f4922B96975C53D89D6", // address _proxyRegistry
  ...
  await instance.init(
    "0x5F3fD21232C976773233f8E5F5d6564cf2820512", // address _borrowerOperations,
    "0x7df27F6B3C8A2b6219352A434872DcDd8f5a50E4", // address _troveManager,
    "0xa0784061348c5D8c76607181f05f2C4eE270239C", // address _priceFeed,
    "" // address _recorder
  );
